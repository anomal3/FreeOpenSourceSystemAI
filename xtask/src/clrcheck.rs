...
const SAMPLES: [(&str, bool); 17] =
    [("hello", true), ("arith", true), ("objects", true), ("exceptions", true), ("generics", true), ("gc", true), ("text", true), ("collections", true), ("floats", true), ("enums", true), ("linq", true), ("files", true), ("time", true), ("form", true), ("winforms", true), ("controls", true), ("features", false)];
...
fn sample_args(sample: &str) -> &'static [&'static str] {
    match sample {
        ...
        "form" | "winforms" | "controls" => &["self-test"],
        _ => &[],
    }
}
