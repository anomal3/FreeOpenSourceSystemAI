...
const SAMPLES: [(&str, bool); 32] =
    [("hello", true), ("arith", true), ("objects", true), ("exceptions", true), ("generics", true), ("gc", true), ("text", true), ("collections", true), ("floats", true), ("enums", true), ("linq", true), ("files", true), ("time", true), ("form", true), ("winforms", true), ("controls", true), ("lists", true), ("dialogs", true), ("layout", true), ("choices", true), ("tabs", true), ("numbers", true), ("keys", true), ("pqueue", true), ("sorted", true), ("nullable", true), ("listsort", true), ("dict", true), ("asyncs", true), ("drawing", true), ("gallery", true), ("features", false)];
...
fn sample_args(sample: &str) -> &'static [&'static str] {
    match sample {
        ...
        "form" | "winforms" | "controls" | "lists" | "dialogs" | "layout" | "choices" | "tabs" | "numbers" | "keys" | "drawing" | "gallery" => &["self-test"],
        _ => &[],
    }
}
