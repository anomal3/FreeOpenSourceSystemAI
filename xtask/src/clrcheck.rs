...
fn sample_args(sample: &str) -> &'static [&'static str] {
    match sample {
        ...
        "form" | "winforms" | "controls" | "lists" | "dialogs" | "layout" | "choices" | "tabs" | "numbers" | "keys" | "gallery" => &["self-test"],
        _ => &[],
    }
}
