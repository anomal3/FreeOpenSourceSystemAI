...
const SAMPLES: [(&str, bool); 20] =
    [("hello", true), ("arith", true), ("objects", true), ("exceptions", true), ("generics", true), ("gc", true), ("text", true), ("collections", true), ("floats", true), ("enums", true), ("linq", true), ("files", true), ("time", true), ("form", true), ("winforms", true), ("controls", true), ("lists", true), ("dialogs", true), ("layout", true), ("features", false)];
...
fn sample_args(sample: &str) -> &'static [&'static str] {
    match sample {
        ...
        "form" | "winforms" | "controls" | "lists" | "dialogs" | "layout" => &["self-test"],
        _ => &[],
    }
}
