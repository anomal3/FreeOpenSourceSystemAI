...
pub const ALL: &[Scenario] = &[
    ...
    Scenario {
        ...
        steps: &[
            ...
            Step::Await("desktop     : focus 'Terminal'", 15_000),
            // Где угодно в выводе, а не после строки фокуса: программа
            // печатает из своей задачи, стол — из своей, и кто успеет первым,
            // решает планировщик. На отладочном прогоне 13.09 строка программы
            // пришла раньше на обеих архитектурах, и сценарий ждал её впустую.
            Step::AwaitAny("hello from userspace", 30_000),
            Step::Wait(2_000),
            ...
            //
            // Пункт **четвёртый**, а не шестой: из списка окон ядра ушли и
            // монитор системы (47b), и файловый менеджер (47c) — оба стали
            // программами из `/bin`. Меню находит их там же, где остальные, а
            // предлагать два разных способа открыть одно окно незачем.
            Step::Key("f1"),
            Step::Await("desktop     : menu opened", 15_000),
            Step::Repeat("down", 3),
            Step::Key("ret"),
            ...
            //
            // Пункт тот же четвёртый, что и выше.
            Step::Key("f1"),
            Step::Await("desktop     : menu opened", 15_000),
            Step::Repeat("down", 3),
            Step::Key("ret"),
