...
pub const ALL: &[Scenario] = &[
    ...
    Scenario {
        ...
        steps: &[
            ...
            //
            // Допуск в пять минут выбран так, чтобы ловить то, что стоит
            // ловить. Ошибка в часовом поясе — это целый час, ошибка в эпохе —
            // десятилетия; расхождение же в секунды набегает законно, пока
            // прошивка разбирает диск и грузит ядро.
            Step::Clock("clock       : ", 300, BOOT),
            Step::Await("freeos> ", BOOT),
