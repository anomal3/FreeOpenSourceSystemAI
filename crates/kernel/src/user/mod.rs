...
//! # Чего здесь пока нет
//!
//! **Способа снять программу.** Вытеснить её ядро умеет, а завершить по
//! требованию — нет: `kill` означает разбор чужого кадра входа в третье кольцо
//! и уборку за задачей, которую никто не спрашивал. Поэтому программа с вечным
//! циклом хоть и не держит машину, но и не заканчивается, пока не выключат
//! питание.
//!
