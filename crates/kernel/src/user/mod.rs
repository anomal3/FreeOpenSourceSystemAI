...
/// памяти. Настоящее решение — память по запросу (фаза 40), после которой
...
///
/// Цена — 32 КиБ на программу. Настоящее решение — стек, растущий по запросу
/// (фаза 40), и до неё это число остаётся честной константой, а не обещанием.
