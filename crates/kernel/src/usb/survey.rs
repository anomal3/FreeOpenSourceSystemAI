...
const fn describe(prog_if: u8) -> (&'static str, bool) {
    match prog_if {
        ...
        // EHCI не умеет, и это не пробел, а решение: высокоскоростной
        // контроллер сам по себе не разговаривает с низко- и полноскоростными
        // устройствами — клавиатура и мышь достаются его спутнику, то есть
        // OHCI, который стоит рядом и который ядро поднимает.
