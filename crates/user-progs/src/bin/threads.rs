...
//!
//! Существует ради трёх утверждений, каждое из которых на однопоточном ядре
//! проверить нечем.
//!
...
use user_progs::{Args, exit, print, print_u64, println, set_tls, sleep_ms, thread_create, thread_exit};
